# Lib: DFreds UI Extender (lib-dfreds-ui-extender) — v2.3.0
...
## API Surface
### Globals
- `globalThis.uiExtender` / `game.uiExtender`
...
- Easily add new scene controls to any layer controls (token, tiles, drawings, w
```
