# Monk's Wall Enhancement (monks-wall-enhancement) — v14.01
...
Replaces the default wall names and icons with ones intended to be more clear; ``invisible walls`` becomes ``windows``, ``ethereal walls`` becomes ``curtains``. This opti
```
